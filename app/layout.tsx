          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link href="/impact" className="text-sm text-[#8888a0] hover:text-white transition-colors">
                  Impact
                </Link>
                <Link href="/history" className="text-sm text-[#8888a0] hover:text-white transition-colors">
                  History
                </Link>
